      ...
      if (data.setting) {
        try {
          ...
          data.pass_through_result_url =
            parsedSettings.pass_through_result_url || false;
            ...
            const advancedSettingsContent = (
              <div className='space-y-4'>
                ...
                <div className='pt-3'>
                  ...
                  <Form.Switch field='pass_through_result_url' label={t('透传成品地址')} checkedText={t('开')} uncheckedText={t('关')} onChange={(value) => handleChannelSettingsChange('pass_through_result_url', value)} extraText={t('图片/视频成品直接返回上游原始 URL，不中转到本站存储。省带宽，但上游地址通常有有效期（如 24 小时），过期后历史记录中的成品将无法打开。上游只返回 base64 时不受影响，仍会转存。')} />
