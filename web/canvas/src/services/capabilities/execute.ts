...
export async function runTaskCapability(spec: CapabilitySpec, args: { model: string; prompt: string; params: CapabilityParams; slots: SlotValues; group?: string; signal?: AbortSignal; onTaskId?: (taskId: string) => void }): Promise<TaskCapabilityResult> {
